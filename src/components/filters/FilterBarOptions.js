...
const FilterBarOptions = ({category}) => {
    ...
    const newbrand=category?updatedBrandsMenu.filter(product=>product.ct===category):updatedBrandsMenu
    ...
    return (
        <>
            ...
            <div className={`filter_options ${isMobFilterVisible ? 'show' : ''}`}>
                ...
                {/* Filter by Brands */}
                {category && <div className="filter_block">
                    <h4>Brands</h4>
                ...
                {/* Filter by Category */}
                {category===undefined && <div className="filter_block">
                    <h4>Category</h4>
                    <ul className="filter_menu">
                        {
